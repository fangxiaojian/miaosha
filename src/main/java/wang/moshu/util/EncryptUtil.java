 ...
 * DES对称加密算法工具类
 * 
 * @category DES对称加密算法工具类
 * @author xiangyong.ding@weimob.com
 * @since 2016年11月22日 下午6:56:43
 */
public class EncryptUtil
{
	// 密钥是16位长度的byte[]进行Base64转换后得到的字符串
	private static final String key = "KmDIStYtOpF4x2yvYt54EF==";
	...
	public static String decrypt(String str) throws Exception
	{
		...
		try
		{
			encBuf = decoder.decodeBuffer(str);
		}
		catch (IOException e)
		{
			e.printStackTrace();
	 ...
	 * @throws Exception
	 */
	private static byte[] TripleDES_CBC_Encrypt(byte[] sourceBuf, SecretKeySpec deskey, IvParameterSpec ivParam)
			throws Exception
	{
		byte[] cipherByte;
		// 使用DES对称加密算法的CBC模式加密
	 ...
	 * @throws Exception
	 */
	private static byte[] TripleDES_CBC_Decrypt(byte[] sourceBuf, SecretKeySpec deskey, IvParameterSpec ivParam)
			throws Exception
	{
	...
	{
		String encrptStr = encrypt("10007:Gogogo嘿喂狗");
		System.out.println(encrptStr);
		System.out.println(decrypt(encrptStr));
	}
}
